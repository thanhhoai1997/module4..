...
<body>
<div style="margin-left: 20%" class="row col-md-6 ">
    <a class="btn btn-primary" href="/products">Back To My List Products</a>
    <form:form cssClass="form-control bg-warning" method="post" action="/new" modelAttribute="product">
