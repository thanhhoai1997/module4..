...
import com.example.repositories.role.IRoleRepository;
...
//    @GetMapping("/user/{id}")
//    public ResponseEntity<User> getUser(@RequestParam("username") String username,@PathVariable("id") Long id){
//
//        User user = new User();
...
//        roles.add(iRoleRepository.findById(id).get());
//        user.setRoles(roles);
